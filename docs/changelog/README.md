...
| --- | --- | --- |
| 2026-09-20 | Refined Monkeytype EN-VN layout and Recall mode; improved Shooter/Recall UI and restart UX; completed multi-pass child review/CI; pinned reviewed child revisions; and added a root `./play.sh` static Play launcher that avoids Git/dependency updates and only rebuilds stale local apps. | [2026-09-20](./2026-09-20.md) |
