...
| --- | --- | --- |
| 2026-09-20 | Added the shared EN-VN-IPA vocabulary architecture and first 300-entry production batch, source/license attribution, scalable review-only candidate pipeline, Library/Custom dictionary source for Monkeytype, Class/Custom level sources for Shooter and Recall, validator/schema hardening, plus the earlier EN-VN/Recall UI, Stop-on-Error, Shooter visual, restart and static Play-mode refinements. | [2026-09-20](./2026-09-20.md) |
