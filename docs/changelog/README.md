...
| --- | --- | --- |
| 2026-09-20 | Refined Monkeytype EN-VN/Recall UI, added a local EN/VI full-text reader with speed/voice controls, improved Shooter/Recall UX, added static `./play.sh`, fixed macOS Bash 3.2 empty-port cleanup, completed multi-pass review/CI, and pinned reviewed child revisions. | [2026-09-20](./2026-09-20.md) |
