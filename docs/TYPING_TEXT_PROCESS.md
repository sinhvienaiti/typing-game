...
- Levels 001-047 index: 47 levels, 705 passages, 183912 words.
- Next active level: 048.
...
Batch 021-030 is complete on the checkpoint branch. Continue without stopping from Level 048 in Batch 041-050.
