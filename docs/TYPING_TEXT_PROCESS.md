...
- Levels 001-037 index: 37 levels, 555 passages, 144381 words.
- Next active level: 038.
...
Batch 021-030 is complete on the checkpoint branch. Continue without stopping from Level 038 in Batch 031-040.
