...
- Levels 001-039 index: 39 levels, 585 passages, 152477 words.
- Next active level: 040.
...
Batch 021-030 is complete on the checkpoint branch. Continue without stopping from Level 040 in Batch 031-040.
