...
- Levels 011-016 are complete and reviewed on the checkpoint branch.
- Next active level: 017.
...
Continue Level 017 through 020 without stopping. Levels 011-016 are already complete on the checkpoint branch.
