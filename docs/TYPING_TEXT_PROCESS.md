...
- Levels 011-024 cross-check: 210 passages, 54700 words, duplicate/similarity warnings 0.
- Next active level: 025.
...
Continue Batch 021-030 without stopping, starting exactly from Level 025. Levels 021-024 are complete on the checkpoint branch.
