...
- Levels 001-040 index: 40 levels, 600 passages, 156337 words.
- Next active level: 041.
...
Batch 021-030 is complete on the checkpoint branch. Continue without stopping from Level 041 in Batch 041-050.
