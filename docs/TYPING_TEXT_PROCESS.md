...
- Levels 001-041 index: 41 levels, 615 passages, 160319 words.
- Next active level: 042.
...
Batch 021-030 is complete on the checkpoint branch. Continue without stopping from Level 042 in Batch 041-050.
