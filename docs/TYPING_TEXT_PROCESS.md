...
- Levels 001-036 index: 36 levels, 540 passages, 140393 words.
- Next active level: 037.
...
Batch 021-030 is complete on the checkpoint branch. Continue without stopping from Level 037 in Batch 031-040.
