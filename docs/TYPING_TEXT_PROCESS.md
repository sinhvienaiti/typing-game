...
- Levels 011-017 are complete and reviewed on the checkpoint branch.
- Next active level: 018.
...
Continue Level 018 through 020 without stopping. Levels 011-017 are already complete on the checkpoint branch.
