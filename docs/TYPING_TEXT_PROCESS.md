...
- Levels 011-012 are complete and reviewed on the checkpoint branch.
- Next active level: 013.
...
Continue Level 013 through 020 without stopping. Levels 011-012 are already complete on the checkpoint branch.
